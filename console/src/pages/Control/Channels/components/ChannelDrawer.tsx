...
const CHANNEL_DOC_EN_URLS: Partial<Record<ChannelKey, string>> = {
    ...
    xmpp: "https://qwenpaw.agentscope.io/docs/channels/?lang=en#XMPP",
...
const CHANNEL_DOC_ZH_URLS: Partial<Record<ChannelKey, string>> = {
    ...
    xmpp: "https://qwenpaw.agentscope.io/docs/channels/?lang=zh#XMPP",
                    ...
                    <>
                        ...
                        >
                            <Select>
                                ...
                                <Select.Option value="websockets">WebSocket</Select.Option>
                            </Select>
                        </Form.Item>
                        <Form.Item
                            name="jid"
                        ...
                        <Form.Item
                            ...
                            tooltip="可选，自动加入群聊"
                        >
                            <Input placeholder="conference.example.com/room"/>
                        </Form.Item>
                        <Form.Item
                            name="room_nick"
                            label="群聊昵称"
                        >
                            <Input placeholder="QwenPawBot"/>
                        </Form.Item>
                        <Form.Item
                            name="clean_session"
                            label="Clean Session"
                        ...
                        <Form.Item name="tls_ca_certs" label="TLS CA Certs">
                            <Input placeholder="Path to CA certs"/>
                        </Form.Item>
                        <Form.Item name="tls_certfile" label="TLS Certfile">
                            <Input placeholder="Path to client cert"/>
                        </Form.Item>
                        <Form.Item name="tls_keyfile" label="TLS Keyfile">
