...
class XMPPConfig(BaseChannelConfig):
    host: str = ""
    port: Optional[int] = None
    jid: str = ""                      # 对应 username
    password: Optional[str] = None     # 对应 password
    room: str = ""                     # MUC 群聊房间
    room_nick: str = ""                # 群聊昵称
    transport: str = ""                # tcp / websocket
    clean_session: bool = True         # 保持同结构
    tls_enabled: bool = False
    tls_ca_certs: Optional[str] = None
    tls_certfile: Optional[str] = None
    tls_keyfile: Optional[str] = None
